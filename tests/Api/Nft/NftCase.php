...
abstract class NftCase extends TestCase
{
    ...
    abstract public function method(): NftMethod;
    ...
    {
        $data = Solscan::nft()->{Str::camel(Str::replace('/', '_', $this->method()->value))}(...$this->methodOptions());
