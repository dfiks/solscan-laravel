...
namespace DFiks\Solscan\Tests\Api\Block;
...
abstract class BlockCase extends TestCase
{
    ...
    abstract public function method(): BlockMethod;
    ...
    {
        $data = Solscan::block()->{Str::camel(Str::replace('/', '_', $this->method()->value))}(...$this->methodOptions());
