...
abstract class AccountCase extends TestCase
{
    ...
    abstract public function method(): AccountMethod;
    ...
    {
        $data = Solscan::account()->{Str::camel(Str::replace('/', '_', $this->method()->value))}(...$this->methodOptions());
